...
public class EditorsAnnotator {
	...
	public static EditorsAnnotator trackEditorsOf(final IWorkbench workbench) {
		return new EditorsAnnotator(workbench);
	}
	
	private EditorsAnnotator(final IWorkbench workbench) {
		this.workbench = workbench;
		addListenersToEditorWindows();
		annotateAllEditors();
		logger.fine("EditorsAnnotator registered."); //$NON-NLS-1$
	}
